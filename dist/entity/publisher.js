...
var publisher = /** @class */ (function () {
    ...
    ], publisher.prototype, "idx", void 0);
    __decorate([
        (0, typeorm_1.Column)({ nullable: false, type: "varchar", length: 255 }),
        __metadata("design:type", String)
    ], publisher.prototype, "name", void 0);
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return tbl_book_1.default; }, function (book) { return book.publisher; }),
        __metadata("design:type", Array)
    ], publisher.prototype, "books", void 0);
    publisher = __decorate([
        (0, typeorm_1.Entity)({ name: "publisher" })
    ], publisher);
    return publisher;
}());
